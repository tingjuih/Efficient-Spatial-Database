...
public class KVPair<K extends Comparable<? super K>, V>
    ...
    @Override
    /**
     * Check if two KVPairs have the same keys and values
     * 
     * @return a boolean to indicate if two KVPairs are the same or not
     */
    public boolean equals(Object o) {
        ...
        KVPair<K, V> pair = (KVPair<K, V>)o;
        return key.equals(pair.getKey()) && value.equals(pair.getValue());
    }


    /**
     * Translate the KVPair to a human readable string
     * 
     * @return string of key and value without decoration
     */
